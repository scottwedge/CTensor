...
# updated Jan 28, 2020
# manually adjust weights of datasets, to balance learning speed
...
class Autoencoder:
    ...
    def train_autoencoder(self, rawdata_1d_dict, rawdata_2d_dict, rawdata_3d_dict, train_hours,
        ...
        # assumption: weather has lower weights, 3D datasets have higher weights
        # weather: 0.2, 3D datasets: 2
        total_loss = 0
        cost = 0
    ...
    #                     feed_dict_all[self.rawdata_3d_tf_y_dict[k]] = temp_batch
                    ...
                    if itr%10 == 0:
                        print("Iter/Epoch: {}/{}...".format(itr, epoch),
                            ...
                            "Training total equal loss: {:.4f}".format(batch_total_loss))
    ...
    #                     test_feed_dict_all[self.rawdata_3d_tf_y_dict[k]] = temp_batch
                    ...
                    test_batch_cost, test_batch_total_loss, test_batch_loss_dict, test_batch_rmse_dict = sess.run([cost,total_loss, loss_dict, rmse_dict], feed_dict= test_feed_dict_all)
                    # get encoded representation
                    # # [None, 1, 32, 20, 1]
                ...
                ecoch_res_df = pd.DataFrame([[epoch_loss, test_epoch_loss, epoch_total_loss, test_total_loss]],
                    columns=[ 'train_cost', 'test_cost', 'train_total_loss', 'test_total_loss'])
                ...
                with open(txt_name, 'w') as the_file:
                    ...
                    the_file.write(' epoch_loss: weighted sum of loss\n')
                    the_file.write(str(epoch_loss) + '\n')
                    the_file.write(' test_epoch_loss: weighte sum of test loss\n')
                    ...
                    the_file.write(' test_epoch_total_loss: equal weight sum of test loss\n')
                    the_file.write(str(test_epoch_total_loss) + '\n')
                    the_file.write('\n')
