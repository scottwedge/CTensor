...
class train:
    ...
    def __init__(self,  demo_raw,
        ...
        self.window = datetime.timedelta(hours=24)
...
####################### city ignorant treatment ################
    ...
    if suffix == '':
        save_path =  './toy_autoencoder_v2_24hours_'+ 'dim'+ str(dim)  +'/'
    else:
        save_path = './toy_autoencoder_v2_24hours_'+ 'dim' + str(dim) +'_'+ suffix  +'/'
