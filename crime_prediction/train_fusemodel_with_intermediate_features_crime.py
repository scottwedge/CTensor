...
def main():
    ...
    if place == "Seattle":
        ...
        print('test_encoded_list_rearrange_concat[0].shape', test_encoded_list_rearrange_concat[0].shape)
        ...
        test_feature_map_dict = dict(zip(keys_list, test_encoded_list_rearrange_concat))
        ...
        test_temp_arr1 = test_feature_map_dict['group_1']  # train_hours, 32, 20, dim
        test_temp_arr2 = test_feature_map_dict['group_4']
        test_temp_arr3 = test_feature_map_dict['group_5']
        latent_rep_test= np.concatenate([test_temp_arr1,test_temp_arr2, test_temp_arr3], axis=-1)
