# Updated Jan, 2020
# train bikeshare with latent represetnations
# that come from the intermediate features of the encoding part
...
def main():
    ...
    if place == "Seattle":
        ...
        latent_rep_path = '/home/ubuntu/CTensor/toy_examples/toy_autoencoder_v6_cos_dim3_trail/encoded_list'
