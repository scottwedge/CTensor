...
class Autoencoder:
    ...
    def vanilla_autoencoder(self, inputs_):
        ...
        with tf.name_scope("decoding"):
            ...
            # [168, 32, 20, 9]
            output = tf.layers.conv3d(inputs=unpool4, filters=9, kernel_size=[3,3,3], padding='same', activation=my_leaky_relu)
    ...
    def train_autoencoder(self, weather_seq_arr, crime_seq_arr, data_2d, 
...
class Autoencoder_entry:
    def __init__(self, train_obj, train_arr, test_arr, intersect_pos_set, 
        ...
        self.weather_seq_arr = weather_seq_arr
        self.crime_seq_arr = crime_seq_arr
