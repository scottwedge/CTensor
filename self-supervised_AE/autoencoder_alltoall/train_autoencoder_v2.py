...
####################### city ignorant treatment ################
    ...
    if suffix == '':
        save_path =  './nextstep_autoencoder_v2_1to1_'+ 'dim'+ str(dim)  +'/'
    else:
        if key == '':
            save_path = './nextstep_autoencoder_v2_1to1_'+ 'dim' + str(dim) +'_'+ suffix  +'/'
        else:
            save_path = './nextstep_autoencoder_v2_1to1_'+ 'dim' + str(dim) + '_'+ suffix+ '_' + key  +'/'
