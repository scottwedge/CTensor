# autoencoder_featuremap_Grouping
# based on autoencoder_v2: all to all structure
# difference lies in: 2d conv layers are added
# after the 1d feature maps are duplicated
