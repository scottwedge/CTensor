# Use a flat encoder and a hierachical decoder
...
####################### city ignorant treatment ################
    ...
    if suffix == '':
        save_path =  './autoencoder_v5_multidecoder_'+ 'dim'+ str(dim)  +'/'
    else:
        save_path = './autoencoder_v5_multidecoder_'+ 'dim' + str(dim) +'_'+ suffix  +'/'
    ...
    txt_name = save_path + 'autoencoder_v5_multidecoder_' + 'dim_' + str(dim) +'_'  + timer + '.txt'
