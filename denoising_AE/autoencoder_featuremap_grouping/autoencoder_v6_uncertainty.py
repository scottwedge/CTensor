...
class Autoencoder:
        ...
        for grp, data_list in grouping_dict.items():
            for ds in data_list:
                ...
                if ds in keys_1d:
                    ...
                    weighedloss_dict[ds] = temp_loss * self.weights_dict[ds]
    ...
    #                     print('3d temp_batch.shape: ',temp_batch.shape)
                    ...
                    batch_cost, batch_loss_dict, batch_rmse_dict, batch_weighedloss_dict, _ = sess.run([total_loss, loss_dict, rmse_dict, weighedloss_dict, optimizer],
