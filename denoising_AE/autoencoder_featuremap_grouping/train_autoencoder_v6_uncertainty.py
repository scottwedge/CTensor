...
import autoencoder_v6_uncertainty as autoencoder_v6
...
####################### city ignorant treatment ################
    ...
    if suffix == '':
        save_path =  './denoise_autoencoder_v6_shuffle_'+ 'dim'+ str(dim)  +'/'
    else:
        save_path = './denoise_autoencoder_v6_shuffle_'+ 'dim' + str(dim) +'_'+ suffix  +'/'
