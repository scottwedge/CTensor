...
#import lstm
import evaluation
import autoencoder_v2_uncertainty_product as autoencoder_v2
...
def parse_args():
    ...
    parser.add_argument('-pc',   '--pretrained_checkpoint',
                         action="store", help = 'checkpoint path to pretrained models', default = '/home/ubuntu/CTensor/autoencoder_alltoall/individual_ckpt/')
...
####################### city ignorant treatment ################
    ...
    if suffix == '':
        save_path =  './denoise_autoencoder_v2_product_uncertainty_'+ 'dim'+ str(dim)  +'/'
    else:
        if key == '':
            save_path = './denoise_autoencoder_v2_product_uncertainty_'+ 'dim' + str(dim) +'_'+ suffix  +'/'
        else:
            save_path = './denoise_autoencoder_v2_product_uncertainty_'+ 'dim' + str(dim) + '_'+ suffix+ '_' + key  +'/'
