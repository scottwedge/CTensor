...
import autoencoder_v8_multigpu as autoencoder_v8
...
####################### city ignorant treatment ################
    ...
    if suffix == '':
        save_path =  './denoise_autoencoder_v8_3rdlevel_'+ 'dim'+ str(dim)  +'/'
    else:
        save_path = './denoise_autoencoder_v8_3rdlevel_'+ 'dim' + str(dim) +'_'+ suffix  +'/'
    ...
    txt_name = save_path + 'autoencoder_v8_' + 'dim_' + str(dim) +'_'  + timer + '.txt'
