# updated May 12, 2020
# interpolate average household income in 2018
...
def main():
    ...
    oracle_set = [ 'edu_uni',  'edu_high', 'no_car_hh', 'age65', 'row_x',  'col_x' ]
    ...
    timer = str(time.time())
    txt_name = save_path + 'income' +   timer + '.txt'
