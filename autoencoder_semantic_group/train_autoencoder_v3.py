...
####################### city ignorant treatment ################
    ...
    if suffix == '':
        save_path =  './autoencoder_v3_'+ 'dim'+ str(dim)  +'/'
    else:
        save_path = './autoencoder_v3_'+ 'dim' + str(dim) +'_'+ suffix  +'/'
    ...
    # Model fusion without fairness
        print('Train Model')
        latent_representation = autoencoder_v3.Autoencoder_entry(train_obj,
    ...
    txt_name = save_path + 'autoencoder_v3_' + 'dim_' + str(dim) +'_'  + timer + '.txt'
