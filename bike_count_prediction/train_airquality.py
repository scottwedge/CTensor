...
def main():
    ...
    if use_1d_fea:
        ...
        print(hourly_grid_timeseries['precipitation'][:168].corr(hourly_grid_timeseries['beacon_hill'][:168]))
        print(hourly_grid_timeseries['temperature'][:168].corr(hourly_grid_timeseries['beacon_hill'][:168]))
