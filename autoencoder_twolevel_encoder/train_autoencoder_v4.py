# flat decoder, hierachical encoder
...
####################### city ignorant treatment ################
    ...
    if suffix == '':
        save_path =  './autoencoder_v4_twolevelencoder_'+ 'dim'+ str(dim)  +'/'
    else:
        save_path = './autoencoder_v4_twolevelencoder_'+ 'dim' + str(dim) +'_'+ suffix  +'/'
    ...
    if resume_training == False:
        ...
        if inference == False:
            ...
            print('Train Model')
            latent_representation = autoencoder_v4.Autoencoder_entry(train_obj,
    ...
    txt_name = save_path + 'autoencoder_v4_twolevelencoder_' + 'dim_' + str(dim) +'_'  + timer + '.txt'
