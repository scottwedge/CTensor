# group datasets by dimension first.
# within each shape, stack datasets together like early fusion
# to form bulks. e.g., 1d bulk, 2d bulk, 3d_7h, 3d_168h
# this version try 1d and 2d grouping first
# reconstruct each bulks of data
# last updated: Dec 13, 2019

# note: 2d cnn model, output dim changed to 3
...
class Autoencoder:
    ...
    output: (32, 20, 1)
    '''
    def cnn_2d_model(self, x_2d_train_data, is_training, output_dim = 3, seed=None):
    ...
    #                     print('3d temp_batch.shape: ',temp_batch.shape)
                ...
                test_end = rawdata_1d_dict['data_1d'].shape[0] -168  # 45984 - 168
